...
ZoomPic.prototype = {
    initialize: function (id) {
        ...
        this.options = [{ width: 829, height: 594, top: 152, left: 0, zIndex: 1 },
        { width: 829, height: 594, top: 152, left: 300, zIndex: 2 },
        { width: 829, height: 594, top: 152, left: 450, zIndex: 3 },
        { width: 829, height: 594, top: 152, left: 500, zIndex: 4 },
        { width: 998, height: 715, top: 124, left: 488, zIndex: 5 },
        { width: 829, height: 594, top: 152, left: 1068, zIndex: 4 },
        { width: 829, height: 594, top: 152, left: 934, zIndex: 3 },
        { width: 829, height: 594, top: 152, left: 950, zIndex: 2 },
        { width: 829, height: 594, top: 152, left: 720, zIndex: 1 },];
        for (var i = 0; i < this.aLi.length; i++)this.aSort[i] = this.aLi[i]; this.aSort.unshift(this.aSort.pop());
        this.setUp(); this.addEvent(this.prev, "click", this._doPrev); this.addEvent(this.next, "click", this._doNext);
        this.doImgClick(); this.timer = setInterval(function () { _this.doNext() }, 3000);
        this.wrap.onmouseover = function () { clearInterval(_this.timer) }; this.wrap.onmouseout = function () {
